 ...
 * this will actually control a single wheel, but in designs where multiple wheels
 * are connected to the same gearbox (such as most tank drive systems), it will
 * actually control those wheels.
 */
public class MotorController {
    ...
    /**
     * Creates a new {@link MotorController} with one motor.
     *
    ...
    /**
     * Creates a new {@link MotorController} with two motors.
     *
     * @param motor the {@link SpeedController} that powers the wheel
     * @param motor2 the second {@link SpeedController} that powers the wheel
     */
    public MotorController(SpeedController motor, SpeedController motor2) {
        this(new SpeedController[]{motor, motor2});
    }

    /**
     * Creates a new {@link MotorController} with three motors.
     *
     * @param motor the {@link SpeedController} that powers the wheel
     * @param motor2 the second {@link SpeedController} that powers the wheel
     * @param motor3 the third {@link SpeedController} that powers the wheel
     */
    public MotorController(SpeedController motor, SpeedController motor2, SpeedController motor3) {
        this(new SpeedController[]{motor, motor2, motor3});
    }

    /**
     * Creates a new {@link MotorController} with an arbitrary number of motors.
     ...
     */
    public MotorController(SpeedController[] motors) {
        this.motors = motors;
    }
